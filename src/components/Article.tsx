  ...
  return (
    <div className='py-2 border-b border-gray-300 mb-4'>
      <div className='relative w-full h-[300px]'>
        <Image src={`${data?.urlToImage !== null ? data?.urlToImage : '/img/news-logo.webp'}`} alt={data?.title} fill sizes="(max-width: 768px) 50vw, (max-width: 1200px) 100vw, 100vw" className='object-cover' />
      </div>
